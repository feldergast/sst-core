...
public:
    ...
    void set_impl(const std::string& value) override { return; }
    ...
    ObjectMapFundamental(TimeConverter** addr) :
        ObjectMap(),
        addr_(addr)
    {}
    ...
    {
        return demangle_name(typeid(TimeConverter).name());
    }
};
